...
class Bittrex(object):
    ...
    def get_historical_data(self, market=None, interval="day"):
        req = "https://bittrex.com/Api/v2.0/pub/market/GetTicks?marketName="+ market +"&tickInterval="+interval

        apisign = hmac.new(self.api_secret.encode(),
                           req.encode(),
                           hashlib.sha512).hexdigest()
        return self.dispatch(req, apisign)
